...
RUN_NAME="grpo_rl0511_8gpu_judge"
...
RUNTIME_ENV=(
    # Only variables read directly by Python/Ray/SwanLab/trace code belong here.
...
echo "StreamWeave judge enable=${JUDGE_ENABLE} backend/model come from configs/streamweave_stepwise.yaml"
