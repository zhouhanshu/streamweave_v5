...
export STREAMWEAVE_DATASET_ROOT="/mmu_mllm_hdd/zhouhanshu/test/exp2/streamweave_v4/dataset"
...
"${PYTHON_BIN}" -m verl.trainer.main_ppo \
    ...
    data.train_files="/mmu_mllm_hdd/zhouhanshu/test/exp2/streamweave_v4/dataset/ovo/ovo_rl_lt120s.json" \
