...
DATASET_ROOT="${DATASET_ROOT:-/mmu_mllm_hdd/zhouhanshu/test/exp2/streamweave_v4/dataset}"
...
ROLLOUT_GPU_MEMORY_UTILIZATION="${STREAMWEAVE_GPU_MEMORY_UTILIZATION:-0.75}"
