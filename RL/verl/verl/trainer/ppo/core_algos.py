...
def agg_loss(
    ...
    if loss_agg_mode == "token-mean":
        ...
        loss = verl_F.masked_sum(loss_mat, loss_mask) / (batch_num_tokens + 1e-8) * dp_size
        ...
        loss = verl_F.masked_sum(seq_losses, seq_mask) / (global_batch_size + 1e-8) * dp_size  # seq-mean
