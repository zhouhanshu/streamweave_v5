...
_STREAMWEAVE_CORE_METRIC_KEYS = (
    ...
    "streamweave/note_frequency_score/max",
    "streamweave/note_frequency_score/min",
    "streamweave/note_frequency_score/std",
    "streamweave/grppo_note_frequency_score/mean",
    "streamweave/grppo_note_frequency_score/max",
    "streamweave/grppo_note_frequency_score/min",
    "streamweave/grppo_note_frequency_score/std",
    ...
    "grppo/cohort_step_reward_std/mean",
    "grppo/cohort_step_reward_std/max",
    "grppo/cohort_step_reward_std/min",
    "grppo/cohort_step_reward_std/std",
    "grppo/cohort_answer_credit_std/mean",
    "grppo/cohort_answer_credit_std/max",
    "grppo/cohort_answer_credit_std/min",
    "grppo/cohort_answer_credit_std/std",
    "actor/lr",
    "actor/pg_loss",
    "actor/ppo_kl",
    "actor/kl_loss",
